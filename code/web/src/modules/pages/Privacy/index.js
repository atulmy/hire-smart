  ...
  return(
    <Fade in={true}>
      <div>
        {/* Meta tags */}
        <Helmet>
          <title>Privacy Policy - HireSmart</title>
        </Helmet>
        ...
        <div className={classes.content}>
          <p style={{ marginTop: 0 }}><strong>HIRESMART</strong> ("us", "we", or "our") operates the https://hiresmart.app website (the "Service").</p>

          <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. This Privacy Policy  for HIRESMART is powered by <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator.php">FreePrivacyPolicy.com</a>.</p>
          ...
          <ul>
            ...
            <li>To protect and defend the rights or property of HIRESMART</li>
