  ...
  return async dispatch => {
    ...
    try {
      const { data } = await axios.post(API_URL, queryBuilder({
        ...
        fields: ['_id', 'organizationId { _id }', 'clientId { _id }', 'candidateId { _id }', 'panelId { _id }', 'userId { _id }', 'dateTime', 'mode', 'createdAt']
      }))
  ...
  return async dispatch => {
    ...
    try {
      const { data } = await axios.post(API_URL, queryBuilder({
        ...
        data: { clientId },
        fields: ['_id', 'organizationId { _id, name }', 'clientId { _id, name }', 'candidateId { _id, name }', 'panelId { _id, name }', 'userId { _id, name }', 'dateTime', 'mode', 'createdAt']
      }))
